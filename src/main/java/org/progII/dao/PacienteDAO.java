...
public class PacienteDAO implements AdmConection, DAO<Paciente, Integer> {
  ...
  private static final String sql_update = "UPDATE consultorio_db.paciente SET telefono = ?, nombre = ? WHERE nro_paciente = ?";
  private static final String sql_delete = "DELETE FROM consultorio_db.paciente WHERE nro_paciente = ?";
  private static final String sql_getbyid = "SELECT * FROM consultorio_db.paciente WHERE nro_paciente = ?";
